...
<body class="min-h-screen flex">
  ...
  <!-- Sidebar -->
  <div class="w-72 bg-zinc-900 border-r border-zinc-800 flex flex-col h-screen">
  ...
  <div class="flex-1 flex flex-col">
    <header class="h-16 bg-zinc-900 border-b border-zinc-800 px-8 flex items-center justify-between">
      <h2 class="text-2xl font-semibold capitalize"><?= str_replace('-', ' ', $section) ?></h2>
      <div class="flex items-center gap-4">
        <div class="relative">
          <input type="text" id="global-search" 
                 class="bg-zinc-800 border border-zinc-700 w-80 rounded-3xl py-2.5 pl-11 text-sm focus:outline-none focus:border-orange-500"
